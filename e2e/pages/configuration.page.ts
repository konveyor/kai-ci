...
export class Configuration {
  ...
  public async setEnabledConfiguration(
  ...
  public async setInputConfiguration(
    configuration: ConfigurationOptions,
    value: string
  ) {
    const window = this.vsCode.getWindow();
  ...
  public async setDropdownConfiguration(
    configuration: ConfigurationOptions,
    value: string
  ) {
